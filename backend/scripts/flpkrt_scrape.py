...
def scrape_flpkrt_products(category):
    url = f"https://www.flipkart.com/search?q=protein+supplements=&p%5B%5D=facets.type%255B%255D%3D{category}"
    headers = {
    ...
    if bs == None:
        ...
        for div in product_divs:
                ...
                if result_span:
                    ...
                    parent_div = result_span.find_parent('div', class_='a-section a-spacing-small')
                    if parent_div:
                        product_divs = parent_div.find_all('div', class_='sg-col-py')
                if result_span:
                    if parent_div:
                        product_divs = parent_div.find_all('div', class_='sg-col-inner')
                if result_span:
                ...
                if data_asin:
                    ...
                    name = div.find('div', class_="s-widget-container s-spacing-small s-widget-container-height-small")
